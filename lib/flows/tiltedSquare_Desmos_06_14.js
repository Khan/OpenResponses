...
const modules = (getUserInput, getRemoteData) => [
  ...
  <TwoUpPrompt>
    ...
    <Paragraph>
      Here is someone else finding the area of the 3 by 5 Tilted Square. Think about their strategy.
    </Paragraph>
    <RichEditor
      dataKey="fourbyfour"
      placeholder="If you were going to work with this person to find the area of the 4 by 4 Tilted Square, how would you describe your plan to them? What questions might you have for each other?"
    />
  </TwoUpPrompt>,
];

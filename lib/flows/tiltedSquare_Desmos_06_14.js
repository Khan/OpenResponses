...
const modules = (getUserInput, getRemoteData) => [
  ...
  >
    <Heading>
      Imagine you were going to work with this person to find the area of the 4 by 4 tilted square.
    </Heading>
    <Paragraph>
      How would you describe your plan to them? What questions might you have for each other?
    </Paragraph>
  ...
  partnerWork: {
    ...
    fetcher: async ([furthestPageLoaded], userID, cohort, { userState }) => {
      ...
      if (!referencingUserID) {
        ...
        referencingUserID = otherStudentIDs[
          Math.floor(Math.random() * otherStudentIDs.length)
        ];
        usedRandomID = true;
      }

  ...
  <TwoUpPrompt
    referenceComponent={
      getRemoteData("partnerWork").firstAttempt
        ? <div>
            <Heading>Here is someone else's first and revised attempt.</Heading>
            <div
              style={{
                transform: "scale(0.7)",
            ...
            <Heading>And their revised attempt:.</Heading>
  ...
  partnerWork: {
    ...
    fetcher: async ([furthestPageLoaded], userID, cohort, { userState }) => {
      ...
      return {
        ...
        newUserState: { otherStudentResponseUserID: referencingUserID },
      };
    },
  },
};

...
const modules = (getUserInput, getRemoteData, dispatcher) => [
  ...
  >
    ...
    <Heading>
      Think about the similarities and differences between Jason's and Kate's
      methods. Write at least two observations.
    </Heading>
    <RichEditor
    ...
    <RichEditor
      dataKey="jasonKateQuestions"
      placeholder="I still wonder why..."
    />
  </TwoUpPrompt>,
  ...
  extractFeedbackFromInbox(getRemoteData("_inbox")).length > 0 ? (
    ...
    >
      ...
      <RichEditor
        data={getUserInput(2).jasonKateObservations}
        quotedWork
        hideInReport
      />
      <Paragraph hideInReport>And you had this question:</Paragraph>
      <RichEditor
        data={getUserInput(2).jasonKateQuestions}
        quotedWork
        hideInReport
      />
      <Paragraph>
  ...
  >
    <Paragraph>
      Help support Simon’s claim by writing a better full explanation of his
      method. You may use ideas from Jason and Kate.
    </Paragraph>
  ...
  <BasePrompt>
    ...
    getRemoteData("otherResponses").responses.length > 0 ? (
      <div>
        <Heading>
          Here is your explanation of Simon's method along with the work from
          your classmates.
        </Heading>
        <Paragraph>

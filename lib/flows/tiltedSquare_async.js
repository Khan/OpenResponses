...
const modules = (getUserInput, getRemoteData, dispatcher) => [
  ...
  >
    ...
    <Heading>
      Think about the similarities and differences between Jason's and Kate's methods. Write at least two observations.
    </Heading>
    <RichEditor
  ...
  getRemoteData("reviewees") && getRemoteData("reviewees").responses
    ? <TwoUpPrompt
      ...
      >
        ...
        />
        <Heading>
          Think about what they wrote. Help build on their ideas, and help answer their questions. Write at least two sentences.
        </Heading>
  ...
  >
    <Paragraph>
      Help support Simon’s claim by writing a better full explanation of his method.
  ...
  if (userState.furthestPageLoaded < 1) {
    ...
    const allValidUserIDs = Object.keys(
      ...
      if (
        ...
        console.log(
          `Filtering out ${otherUserID} because they have already been shown to ${otherResponse.userState.reviewerCount} reviewers`,
        );
        return false;
      }
    ...
    while (reviewees.length < numberOfReviewees && allValidUserIDs.length > 0) {
      ...
      const {
        ...
        const oldReviewerCount = (otherStudentData &&

...
const modules = (getUserInput, getRemoteData, dispatcher) => [
  ...
  ////////////////////////////////////////////////////////////////////// 1
  <TwoUpPrompt referenceComponent={<Image path="zoid/zoid_triangles.gif" />}>
    <Paragraph>
  ...
  ////////////////////////////////////////////////////////////////////// 2
  <TwoUpPrompt referenceComponent={<Image path="zoid/zoid_rects.gif" />}>
    <Paragraph>
      {`Beth: "I rotated pieces of the trapezoid to make two rectangles."`}
    </Paragraph>
    <Heading>Do you see how Beth did it?</Heading>
    <MultipleChoice
      dataKey="seeHowBethDidIt"
      choices={["I think I understand Beth's method.", "I'm not sure yet."]}
    />
  </TwoUpPrompt>,

  ////////////////////////////////////////////////////////////////////// 3
  <TwoUpPrompt referenceComponent={<Image path="zoid/zoid_pgram.gif" />}>
    <Paragraph>
      {`Coco: "I made the trapezoid into one long parallelogram."`}
    </Paragraph>
    <Heading>Do you see how Coco did it?</Heading>
    <MultipleChoice
      dataKey="seeHowCocoDidIt"
      choices={["I think I understand Coco's method.", "I'm not sure yet."]}
    />
  </TwoUpPrompt>,

  ////////////////////////////////////////////////////////////////////// 4
  <TwoUpPrompt
    referenceComponent={<Image path="zoid/zoid_solns3.png" />}
  ...
  >
    ...
    <Heading>
      What is similar in the calculations they wrote? What is similar in the
      geometry they drew? Why do the different methods get the same answer?
      Write at least two sentences.
    </Heading>
    <RichEditor
      dataKey="solnObservations"
      placeholder="One thing that is similar is..."
    />
    <Heading>
  ...
  // TODO: put a second peer review page here?
  ...
  extractFeedbackFromInbox(getRemoteData("_inbox")).length > 0
    ? <TwoUpPrompt
      ...
      >
        ...
        <RichEditor
          data={getUserInput(4).solnObservations}
          quotedWork
          hideInReport
        />
        <Paragraph hideInReport>And you had this question:</Paragraph>
        <RichEditor
          data={getUserInput(4).solnQuestions}
          quotedWork
          hideInReport
        />
        <Paragraph>
  ...
  ////////////////////////////////////////////////////////////////////// 7
  <TwoUpPrompt
    referenceComponent={<Image path="zoid/zoid_vars.png" />}
    passThroughInManagerUI
  >
    <Paragraph>
      You've seen ideas from different methods and different students. In your
      own words, explain why the area of a trapezoid can be calculated by 1/2 *
      h * (t + b) or by another formula.
    </Paragraph>
    <Heading>Write at least four sentences.</Heading>
    <RichEditor dataKey="explainFormula" />
  </TwoUpPrompt>,
  ...
  otherResponses: {
    ...
    fetcher: async ([furthestPageLoaded], userID, cohort, { userState }) => {
      ...
      const responses = Object.keys(users)
        ...
        .map(userData => userData.inputs[6].explainSimon);
      return { responses };
    },
  },
};

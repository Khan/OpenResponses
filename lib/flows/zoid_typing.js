...
const modules = (getUserInput, getRemoteData, dispatcher) => [
  ...
  >
    ...
    <Heading>
      The three students are beginning to discuss why their methods work. What
      do you think? Why do the three methods work? How are they connected to
      each other and to formulas that you know?
    </Heading>

...
const modules = (getUserInput, getRemoteData, dispatcher) => [
  ...
  >
    ...
    <Heading>
      ...
      geometry they drew? What is different?
    </Heading>
    <RichEditor
  ...
  ////////////////////////////////////////////////////////////////////// 7
  <TwoUpPrompt referenceComponent={<Image path="zoid/zoid_avg.gif" />}>
    <Heading>
      Now that you have talked about Alma's and Beth's ideas, consider one more
      solution:
    </Heading>
    <Paragraph>
      {`Coco: "I rotated little triangles around to make the trapezoid into a rectangle."`}
    </Paragraph>
  ...
  >
    <Paragraph>
      {`Alma: "I cut the trapezoid into two triangles."
        ...
        Alma: "I notice we all used a 1/2. But, how did you know the width of the rectangle, Coco?"
        Beth: "Wait, I think our methods can help explain Coco's.`}
    </Paragraph>
    <Paragraph>
      Do you see what Alma and Beth noticed? Explain how the three methods are
      connected.
    </Paragraph>
    <Heading>
      Write at least four sentences. This will be your final work.
    </Heading>

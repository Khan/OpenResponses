...
const modules = (getUserInput, getRemoteData) => [
  <BasePrompt>
    ...
    <Paragraph>Find its area by any method, and show your reasoning.</Paragraph>
    <Scratchpad
      dataKey="scratchpad"
  ...
  >
    <Heading>
      Use some ideas from the group you selected to do the problem in a
      different way than you began with:
    </Heading>
    <Paragraph>
      This square can be called a 3 by 5 tilted square. Find its area by any
      method, and show your reasoning.
    </Paragraph>
    <Scratchpad
      dataKey="scratchpad"
      paddingLeft={-30}

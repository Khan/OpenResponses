...
const remoteDataRequirements = {
  otherStudentResponse: {
    ...
    fetcher: async (
      ...
      if (userState && userState.reviewee1) {
        return userState.reviewee1.submission;
      }
      ...
      if (userState.furthestPageLoaded < 1) {
        ...
        const allValidUserIDs = Object.keys(
          ...
          if (
            otherResponse.userState.reviewerCount >=
              maximumTimesResponseShown &&

...
const modules = (getUserInput, getRemoteData) => [
  ...
  <TwoUpPrompt {...twoUpPromptProps}>
    ...
    <Paragraph>
      Does their reasoning clearly support their argument? Has their response changed your mind on anything? How would you help them improve their work?
    </Paragraph>
    <RichEditor
      dataKey="feedback"
  ...
  // 3
  getRemoteData("feedback").feedback
    ? <TwoUpPrompt {...twoUpPromptProps}>
        <Heading>
          {

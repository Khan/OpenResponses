...
const modules = (getUserInput, getRemoteData, dispatcher) => [
  ...
  <BasePrompt>
    ...
    <Image path="zoid/zoid_problem1.png" />
    <Paragraph>
      {`We asked you to find the area. You said: ${getUserInput(3)
        .practice}. Our answer: 18.
    ...
    <Image path="zoid/zoid_problem2.png" />
    <Paragraph>
      {`We asked you to find the area. You said: ${getUserInput(4)
        .practice}. Our answer: 10.
      
      `}
    </Paragraph>

    <Heading>Problem 3</Heading>
    <Image path="zoid/zoid_problem3.png" />
    <Paragraph>
      {`We asked you to find the area. You said: ${getUserInput(5)
        .practice}. Our answer: 42.

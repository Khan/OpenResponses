...
const modules = (getUserInput, getRemoteData, dispatcher) => {
  ...
  modules[0] = (
    ...
    >
      ...
      <Paragraph hideInReport>
        {`Now brainstorm at least ways in which gender relations and family structures *changed* as ${religionPhrase} in 600–1450 C.E.`}
      </Paragraph>
  ...
  if (reviewees && reviewees.responses && reviewees.responses[0]) {
    ...
    modules[1] = (
      ...
      >
        ...
        <Paragraph>{`Here are some prompts that might help:

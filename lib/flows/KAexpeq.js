...
const modules = (getUserInput, getRemoteData) => [
  ...
  <BasePrompt>
    <Paragraph>Equivalent Expressions</Paragraph>
    <Scratchpad
      dataKey="scratchpad"
  ...
  <BasePrompt>
    ...
    <Paragraph>
      Select a work sample or two that you feel is *helpful*, *interesting*, or
  ...
  >
    <Paragraph>
      Here is a new problem, use the ideas you saw in the work of others to help
      you write a full complete solution
    </Paragraph>
    <Scratchpad
      dataKey="scratchpad"
      paddingLeft={-30}
  ...
  <BasePrompt>
    ...
    />
    <Paragraph>Expand -r + 8(-5r + 2)</Paragraph>

...
export default class Welcome extends React.Component {
  ...
  onSubmit = () => {
    const { email, pseudonym, avatar, realName } = this.state;
    this.props.onSubmit &&
      this.props.onSubmit({ email, pseudonym, avatar, realName });
  };
  ...
  render = () => {
    ...
    return (
      <form className={css(styles.container)}>
        ...
        <p className={css(styles.paragraph, styles.step)}>
          2. React to your classmates’ work.
        </p>
        <p className={css(styles.paragraph, styles.step)}>
          3. Revise your own work based on what youʼve learned.
        </p>
        ...
        <div className={css(styles.formRow)}>
          ...
          <p className={css(styles.secretIdentity)}>
            ...
            <span className={css(styles.identityName)}>

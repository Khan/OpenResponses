...
export default class QuillRichEditor extends React.Component {
  ...
  constructor(props) {
    ...
    if (typeof window !== "undefined") {
      ReactQuill = require("../../vendor/react-quill.min.js");
    }
  }
  ...
  focus = () => {
    const rawEditor = this.reactQuillRef.getEditor();
    rawEditor.setSelection(rawEditor.getLength(), 0);
  };
      ...
      <Fragment>
        ...
        <style global jsx>{`
          ...
          .ql-editor {
            padding: 0;
            line-height: unset;
            min-height: ${this.props.minHeight || "5em"};
          }

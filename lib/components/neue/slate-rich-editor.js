...
export const dataKind = "rich-editor";

export default class SlateRichEditor extends React.Component {
  static defaultProps = {
    data: {
      kind: dataKind,
    },
      ...
      effectiveProps = {
        ...
        data: {
          ...
          rawData: JSON.stringify(
            Plain.deserialize(props.initialString || "").toJSON(),
          ),
        },
      };
    }
      ...
      <div
        className={css(
          ...
          this.props.inManagerInterface && this.props.quotedWork
            ...
            : undefined,
          editorState.isFocused ? styles.editorContainerFocused : undefined,
        )}
      >
        {this.renderMenu()}
        <Editor

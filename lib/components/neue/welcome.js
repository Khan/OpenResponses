    ...
    return (
      <div className={css(styles.container)}>
        ...
        <p className={css(styles.paragraph, styles.step)}>
          <span className={css(styles.stepNumber)}>1</span>
          Write a response to an open-ended prompt.
        </p>
        <p className={css(styles.paragraph, styles.step)}>
          <span className={css(styles.stepNumber)}>2</span>
          See and give feedback to your classmates’ work.
        </p>
        <p className={css(styles.paragraph, styles.step)}>
          <span className={css(styles.stepNumber)}>3</span>
          Reflect on what you’ve learned from the activity.
        </p>
...
const styles = StyleSheet.create({
  ...
  stepNumber: {
    ...sharedStyles.wbTypography.headingSmall,
    boxSizing: "border-box",
    borderWidth: 2,
    borderStyle: "solid",
    borderColor: sharedStyles.wbColors.productBlue,
    color: sharedStyles.wbColors.productBlue,
    flex: "0 0 auto",
    width: 44,
    height: 44,
    borderRadius: 22,

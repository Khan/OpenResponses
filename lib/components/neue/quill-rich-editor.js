  ...
  render() {
    return (
      <Fragment>
        ...
        />
        <style global jsx>{`
          /* NOTE(andy): I'm having extended battles with Webpack right now
             about importing the external Quill CSS successfully given that
             we're using a react-quill from a pull request. I'm not sure why
             it thinks the pull-request-y package is invalid, but I've spent
             enough time fighting it for now, so copy pasta it is: */

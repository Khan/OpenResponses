...
In 5–8 sentences, develop an argument that evaluates how the adoption of agriculture in this time period affected the development of human societies. Be sure to include specific factual evidence supporting both what changed and what stayed the same.`,
  ...
  ties: {
    ...
    prompt: {
      type: "default",
      prompt: `"The opportunity to learn—the necessary resources, the curriculum opportunities, the quality teachers—that affluent students have, is what determines what people can do in life." 

- Linda Darling-Hammond, Professor of Education at Stanford University
      
Do you think the way we handle technology in schools is widening the opportunity gap, or closing it? What improvements to implementation might further close the opportunity gap? Cite evidence from your own teaching experience to strengthen your argument.`,
    },
    engagementPrompts: [
      "Another piece of evidence supporting this argument would be…",
      "This argument’s strongest critic might say…",
      "One implication of this argument to add might be…",
    ],
    reflectionPrompts: [],
    revieweeCount: 2,
  },
